    ...
    <div className='flex flex-col gap-2'>
      ...
      {/* Product list */}
      {
        list.map((item,index)=>(
          ...
          <p onClick={()=>removeProduct(item._id)} className='text-right  md:text-center cursor-pointer text-lg   md:bg-red-100 md:w-[30px] md:text-red-700 md:shadow md:rounded-[5px]'>X</p>
